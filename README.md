...
You can then execute your native executable with: `./target/agentic-social-network-1.0.0-SNAPSHOT-runner`
...
- Flow LangChain4j ([guide](https://docs.quarkiverse.io/quarkus-flow/dev/)): LangChain4j Agentic Workflow implementation for Quarkus Flow.
